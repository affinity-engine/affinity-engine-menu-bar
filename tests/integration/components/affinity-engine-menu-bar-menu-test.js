...
test('it displays the header', function(assert) {
  ...
  this.render(hbs`{{affinity-engine-menu-bar-menu header="bar" translator=translator keyboard=keyboard engineId="foo"}}`);
...
test('it hides the header when not present', function(assert) {
  ...
  this.render(hbs`{{affinity-engine-menu-bar-menu keyboard=keyboard engineId="foo"}}`);
...
test('it displays the choices', function(assert) {
  ...
  this.render(hbs`{{affinity-engine-menu-bar-menu choices=choices columns=1 translator=translator keyboard=keyboard engineId="foo"}}`);
...
test('it displays the correct number of columns', function(assert) {
  ...
  this.render(hbs`{{affinity-engine-menu-bar-menu choices=choices keyboard=keyboard columns=2 engineId="foo"}}`);
...
test('clicking a choice returns the choice object', function(assert) {
  ...
  this.render(hbs`{{affinity-engine-menu-bar-menu choices=choices keyboard=keyboard columns=1 engineId="foo" onChoice=(action onChoice)}}`);
